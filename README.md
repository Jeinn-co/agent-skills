...
| [`ai-cli-version`](skills/ai-cli-version/) | Whether your Claude Code, Codex and Grok Build CLIs are up to date — installed version and when you installed it, latest version and when it was released. When updates are available, choose `y` to update all or `Esc` to skip. Tested on Windows only; macOS and Linux not yet tested. | [README](skills/ai-cli-version/README.md) · [中文](skills/ai-cli-version/README.zh-TW.md) |

The same `/ai-usage` command, run in Claude Code, Codex CLI and Grok CLI:

**Claude Code**

![ai-usage running in Claude Code](skills/ai-usage/images/demo-claude-code.png)

**Codex CLI**

![ai-usage running in Codex CLI](skills/ai-usage/images/demo-codex.png)
